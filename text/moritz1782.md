...
Various details are not completely thought through and the examples are sometimes slightly inconsistent. For example, the phrase *von der Schulter* in clause 11 is analyzed as an adverbial *Hinanfügung*, while the completely parallel *auf die Schulter* in clause 18 is analyzed as an object-like *zweites Ziel*.
