# PART II: The German literature {.unnumbered}

# Reinvigorating syntactic analysis

## A mostly forgotten tradition

The 19th century is widely regarded as the heyday of modern linguistics, particularly in Germany. Many of the great names in the history of linguistics were German scholars of this period, like von Humboldt, Bopp, Grimm, Schleicher, Paul, and many other. Yet, none of these greats will feature in this book. Instead, most of the scholars discussed here will be completely unfamiliar to most contemporary linguists. The main reason is that the well-known scholars from the 19th century were primarily concerned with the historical and psychological dimensions of language and paid comparatively little attention to the problems of syntactic analysis.

By contrast, linguists with stronger philological and didactic interests in the 19th century were constantly confronted with those long, complicated and sometimes remarkably intricate sentences produced by the canonical and maybe even idolated authors and poets whose works they studied. To elucidate these long-winding sentences, whether as part of their investigations of stilistic characteristics, or in order to explain these structures to soccessive generations of philological students, many scholars began to employ graphical methods for syntactic analysis. For many of the authors discussed here didactic considerations were an important motivation (see [@sec:textbooks]), but an equally important impetus came from the study of literary style (see [@sec:literary]).

Surprisingly, all these graphical approaches can be traced back to a small group of grammarians who lived and worked around Frankfurt am Main in the 1820s, specifically Simon Herling and Karl Ferdinand Becker (see [@sec:frankfurt]). Herling and Becker themselves used graphical methods only sparingly, but their work inspired others to develop their approaches to syntactic analysis further. Through many twists and turns, this tradition eventually led to the dependency grammar of Lucien Tesnière.

Towards the end of the 19th century a different approach to syntactic analysis emerged in Germany, shaped primarily by algebraic and logical influences (see [@sec:germanconstituency]). Although this approach never gains widespread prominence in Germany, it had a direct influence on the Danish tradition through Otto Jespersen (see [@sec:danish]) and, more importantly, the American tradition through Leonard Bloomfield (see [@sec:ic]). This line of development led to the style of constituency grammar mainly associated today with Noam Chomsky.

Before turning to the German 19th-century literature on graphical syntactic analysis, however, a few terminological developments need to be considered. These played a central role in discussions of syntax around 1800 and provide an essential background for understanding the analyses discussed throughout this part of the book. The first development is the gradual emergence of the terms subject, object and predicate as the central concepts of sentence structure. This modern trinity of syntactic structure only crystallized at the beginning of the 19th century (see [@sec:subjectobject]). The second development is the emergence of the concept of the *nackte* 'naked' sentence as the minimal structure underlying syntactic analysis and the analysis of highly elaborated and complex sentences was regulary framed in terms of the *Periode*, a classical concept that has largely disappeared from contemporary linguistic terminology (see [@sec:nackt]).

## The subject-object-predicate trinity {#sec:subjectobject}

Slowly, during the 17th and 18th century, a new terminological amalgamation arose, combining terms from Aristotelian logic with concepts from the descriptive grammatical tradition. The result of this mixture are the contemporary terms "subject", "object" and "predicate", which seem to be first used in the modern sense at the start of the 19th century in Germany. The history of the emergence of these terms deserves a detailed investigation in it's own right [cf. @forsgren1985; -@forsgren1992]. The following summary is but a very short and strongly simplified overview of this terminological development. The underlying impetus for this development appears to be an ambition on behalve of grammarians to insert more "logic" into their analyses, or, in more modern terms, to create general terms for ~~grammatical functions~~ (e.g. "subject") on top of the description of the ~~grammatical form~~ (e.g. "nominative") of linguistic elements.
...
These are just a few examples of the gradual adoption of erstwhile logical terminology into the realm of grammatical description. The expansion of this terminology in the 17th and 18th century needs a more detailed investigation than what I am able to provide here. But by the start of the 19th century the terms *subject*, *object*, *predicate* and *copula* all seem to have been accepted as regular terms for grammatical analysis. Yet, there are two aspects of the logical origin of these terms that spill over into the grammatical realm and remain widespread in the 19th century and beyond. These are, first, the balanced and privilaged bond between subject and predicate [cf. the "S-P-Funktion" in @forsgren1992: 75-76] and, second, the discussion about the universality of the copula [cf. the "Copula-Theorie" in @forsgren1992: 135-153].

The privilaged bond of subject and predicate is represented in very many graphical approaches as the basic division of the sentence structure. This might very well be a residue of the classical linguistic concepts of Greek *ὄνομᾰ*/*ῥῆμα* or Latin *suppositum/appositum*. Additionally, the Indo-European languages analysed with graphical approached all only have verb inflection for the subject and not the object. More general analyses with the verb as the centre of the sentence projecting multiple arguments arise only later, probably first by Sámuel Brassai in 1873 (see [@sec:brassai1873]), but with much more impact by Franz Kern in 1883 (see [@kern1883]). This approach only very slowly spreads among syntactic analyses.

The idea that every sentence should contain some kind of copula is less widespread. At the start of the 19th century the verb is sometimes still considered to be an amalgamation of a copula and a predicate, but this conceptualisation vanishes in the first half of the century. However, much later Wilhelm Wundt still deemed it necessary to argue agains the "old grammarians" insisting on a univeral copula [@wundt1900b: 222-224].

## *Nackte Sätze* and the *Periode* {#sec:nackt}

In German grammars of the late 18th and early 19th century there is a widespread conceptual distinction between a bare and an extended sentence. A bare sentence is mostly defined as a sentence with only a subject and a predicate, without any attributive or adverbial modifiers; a minimal sentence of sorts. The examples given always have intransitive verbs and it remains unclear whether transitive sentences also could be "bare". An extended sentence, in contrast, contains additional attributive and adverbial modifiers. Complex sentences with subordinate clauses are mostly relegated to yet another categories of sentence structure, called the *Periode*.

The distinction between bare and extended sentences is mostly referred to using the German words *nackt* 'naked' vs. *ausgebildet* 'developed'.^[This distinction might have been inspired by the latinistic tradition distinguishing between *syntaxis regularis* and *syntaxis ornata*.] However, there is some interesting variations and discussion throughout the 19th century about exactly which word should be used. The origin of this terminological distinction can probably be traced back to Meiner [-@meiner1781: 446], who uses the terms *bloß* 'bare' for a minimal sentence and *ausgebildet* 'developed' for a sentence with additional modifiers. Contemporaneously, Adelung [-@adelung1782: 572] uses the terms *einfach/nackt* 'simple/naked' and *ausgebildet* 'developed'. This terminology is slightly changed in the first edition of Heyse's influential grammar of German [@heyse1814: 492-492] into *einfach/rein* 'simple/pure' and *ausgebildet/erweitert* 'developed/extended'. Then Heyse adjusted this again in the second edition by adding the term *nackt* 'naked, bare' as an alternative to *einfach* and *rein* [@heyse1820: 598]. Finally, in the fourth edition of 1827 Heyse adds the term *bekleidet* 'dressed': 
...
The term *Periode* as a grammatical term for the complex sentence with multiple subordinate clauses is widespread in German 18th and 19th century grammatical texts. For example, it is used already by Meiner [-@meiner1781: 446] and Heyse [-@heyse1814: 491] and it appears in many works to be discussed in this book. The precise definition is constantly being disputed, but most authors use the term *Periode* for a complex sentence with many subordinated clauses.
...
> … einen Verein von Gelehrten hiesiger Gegend zu stiften, der es sich angelegen seyn ließe, zur Veredlung und Verherrlichung unserer Muttersprache sein Möglichstes beizutragen. [@grotefend1818: 7]
>
> ('… to found an association of scholars from the local area, dedicated to contributing to the refinement and glorification of our mother tongue.')

Grotefend took the initiative and in 1817 founded the *Frankfurtische Gelehrtenverein für deutsche Sprache*, in part because he regarded it as a fitting commemoration of the 300th anniversary of Luther's infamous theses, which were, in Grotefend's view, one of the principal driving forces behind the establishment of the German standard language. It also should be noted that Frankfurt at that time did not have a university, so there was no dedicated space for scholarly discussion. Grotefend gathered a circle of interested friends and colleagues and asked Julius Bernhard Engelmann (1773-1844) to host the inaugural meeting in January 1818 at his home at the *Junghof*, where Engelmann ran a girl's school. Over the following years, the society published four volumes of proceedings, the last appearing in 1824.^[Digital version of these proceedings are available online at <https://mdz-nbn-resolving.de/bsb10583285>, <https://mdz-nbn-resolving.de/bsb10583286>, <https://mdz-nbn-resolving.de/bsb10583287>, and <https://mdz-nbn-resolving.de/bsb10583288>.] The society then seems to have gradually faded away, although various people continued to identify themselves as members for some time. For example, Becker [-@becker1833] describes himself on the title page of his *Leitfaden* still as *Mitglied des Franfurter* [sic!] *Gelehrtenvereins für deutsche Sprache*.

During its brief existence, the society became a meeting place for several early proponents of new approaches to syntactical analysis. Among those present at the inaugural meeting was Simon Heinrich Adolf Herling [1780-1849, see @sec:herling1823], Grotefend's colleague at the *Städtische Gymnasium*. When Grotefend left Frankfurt for Hannover in 1821, Herling succeeded him as chairman of the society. Unfortunately absent from the first meeting was their recently deceased colleague Georg Michael Roth (1769-1817), who is mentioned repeatedly in the published proceedings. Grotefend, Roth and Herling had already been close colleagues for many years. In 1812 they had all been appointed to the newly established *Lyceum Carolinum* in Frankfurt, which was dissolved after only two years, following political changes in 1814.

In 1821 the brothers Jakob and Wilhelm Grimm from Kassel were admitted as new members. Karl Ferdinand Becker [1775-1849, see @sec:becker1829], then a teacher in Offenbach, and Friedrich Jakob Schmitthenner [1796-1850, see @sec:schmitthenner1824], at that time a teacher in Dillenburg, joined the society in 1824. August Grotefend [1798-1836, see @sec:grotefend1825], the founder's nephew, later recounted that he became a member in 1827. During this period Herling and Becker developed a particularly close friendship, and even planned to write a grammar together. They eventually decide to pursue seperate projects instead. Each of them published a two-volume grammar, with one volume in each case dedicated to the other [@becker1827;@becker1829;@herling1830;@herling1832].
...
The works of Herling and Becker proved enormously influential. Outside of Frankfurt, their ideas were further developed by Adolph Diesterweg [1790-1866, see @sec:diesterweg1830] and Johann Lehmann [1802-1883, see @sec:lehmann1833], initiating a central line of development that ultimately underlies almost all other approaches to graphical syntax. The only major independently developed tradition is the 19th century American school of sentence diagramming. For all other graphical approaches, including those by Tesnière and Chomsky, the lines can be drawn back to Frankfurt am Main in the 1820s.
...
::: {.im #herling1832_232}
Notation of Herling [@herling1823: 177], shown here from a later edition [@herling1832: 232], for the analysis of subordinate clauses in complex sentence structure. The different letters have a grammatical meaning, with *h* for main clauses, *b* for relative clauses, *a* for adverbial clauses and *s* for nominal clauses. Superscript numbers are used for the depth of the embedding.
:::
...
## Schmitthenner (1824) *Lehre von der Satzzeichnung* {#sec:schmitthenner1824}

Friedrich Jakob Schmitthenner (1796-1850) was school director in Dillenburg and later professor for history and organisation of state at the university of Gießen. He wrote various books about German grammar in the 1820s and was part of the *Frankfurtischer Gelehrtenverein für deutsche Sprache*, alongside Herling ([@sec:herling1823]) and Becker ([@sec:becker1829]). 

In his books about German grammar Schmitthenner consistently included a discussion about the *Periode*. There is not yet any graphic in the *Sprachlehre* [@schmitthenner1822: 320-322]. However, a very similar discussion a few years later includes the graphical representation as shown in [@fig:schmitthenner1824_28] [@schmitthenner1824: 27-30]. Basically the same discussion is also found in his *Teutonia* [@schmitthenner1828: 185-186]. This graphical approach is taken over by Götzinger (see [@sec:götzinger1827]) and also ends up in the work of Diesterweg (see [@sec:diesterweg1830]).

For Schmitthenner, each *Periode* (by definition) consists of two parts, the *Vordersatz* and *Nachsatz*, separated by a colon. Each of these parts can consist of mutliple *Glieder (Kola)*, separated by semicolons. Each *Glied* in turn can consist of multiple *Abschnitte (Kommaten)*, i.e. individual sentences. These *Abschnitte* are not indicated in the graphical representation. He gives various examples of such structures from contemporeneous literature. Shown in [@next] is a quotation from Friedrich Schlegel that exemplifies the last option at the bottom of [@fig:schmitthenner1824_28]. Note that the colon between the *Vordersatz* and the *Nachsatz* in this example (at the end of *Glied* 3) is not found in the original from Schlegel. Schlegel uses a semicolon here as well. Schmitthenner changed it to a colon according to his preferred typographic structure.

::: ex
[*Glied* 1]{.grey} Wenn es natürlich ist, daß der tiefsinnige Geist des Mittelalters, auf den unsre ganze Verfassung und jetziges Leben sich gründen, und noch lange gründen werden, uns in der Geschichte, Dichtkunst und Sittenlehre vor allen am nächsten steht, und die Kenntniß desselben für das Leben am wichtigsten ist; \
[*Glied* 2]{.grey} wenn das griechische Studium die beste nicht nur, sondern eine durchaus nothwendige Vorbereitung und Schule gründlicher Gelehrsamkeit bleibt, weil nirgends sonst wo die Kritik als Kunst so vollständig ausgebildet worden; \
[*Glied* 3]{.grey} wenn endlich auch die Kunst, die Philosophie und Poesie der Griechen, falls wir nicht bloß bei der äussern Form stehen bleiben, wie die Buchstabengelehrten und gewöhnlichen Aesthetiker und Kunstkenner, theils an sich von hohem Werthe, theils aber auch ein unentbehrliches Mittelglied der europäischen Bildung und der orientalischen Ueberlieferung sind, so wie die römische Literatur den Uebergang von den Griechen zum Mittelalter bildet: \
[*Glied* 4]{.grey} so dürfte doch das indische Studium allein dahin führen, die bis jetzt noch ganz unbekannten Gegenden des frühsten Alterthums aufzuhellen, und dabei an dichterischen Schönheiten und philosophischem Tiefsinn nicht minder reiche Schätze darzubieten haben. \
[@schmitthenner1824: 29-30, citing Friedrich Schlegel *Über die Sprache und Weisheit der Indier*.]
:::

::: {.im #schmitthenner1824_28}
Structure for multi-clause extended sentences like [@last], the so-called *Periode*, from Schmitthenner [-@schmitthenner1824: 28]. According to Schmitthenner, a *Periode* consists of multiple *Glieder (Kola)*, the *Glieder* consist of *Abschnitte (Kommaten)*. The lines in the graphic indicate *Glieder*, separated by colons or semicolons.
:::

## Grotefend (1825) *Commentar zu den Materialien lateinischer Stilübungen* {#sec:grotefend1825}
...
Friedrich *Adolph* Wilhelm Diesterweg (1790-1866) was a teacher and a prolific author of textbooks. He also wrote extensively about didactic methods in general, strongly influenced by the ideas of Pestalozzi. Later in life he was politically active in an attempt to reform the Prussian educational system. Early in his career (1813-1818) he was a teacher at the *Musterschule* in Frankfurt am Main, and apparently he applied for a position at the *Gymnasium* [@hock1994] at which Herling was a professor (see [@sec:herling1823]). They might very well have crossed paths in that period, but both were still young and did not yet had published anything. Diesterwegs only started his linguistic work much later while he was director of the teacher's seminary in Moers between 1820 and 1832.

Diesterwegs practical textbooks mainly dealt with mathematics and German linguistics. A comprehensive analysis of his linguistic work can be found in Czoska [-@czoska1984]. Although his linguistic work is not cited much, and is basically unknown to contemporary linguists, it seems to have had a substantial influence on syntactic analysis in the 19th century. Specifically, Diesterweg might have influenced Billroth (see [@sec:billroth1832], though the evidence is only circumstantial) and consequently ignited the tradition of line diagrams for dependency trees. Diesterweg's influence is explicitly acknowledged by Honcamp ([@sec:honcamp1838]), Mager ([@sec:mager1840]), Wander ([@sec:wander1856]), Schlecht ([@sec:schlecht1856]) and Buslaev ([@sec:buslaev1844]).
...
In the preface to the second edition from 1834, Diesterweg calls his approach *Elementarmethode* 'elementary method' (a clear nod to Pestalozzi), in opposition to the *wissenschaftliche oder die constructive Methode* 'scientific or constructive method' [@diesterweg1834: xii-xiii]. As examples of the scientific method he explicitly cites Herling, Becker, Götzinger and Schmitthenner, all of which he deems inappropriate for secondary education. Still, the subsequent proposals Diesterweg makes in his book are all clearly inspired by these authors.

In the first edition from 1830, Diesterweg includes a graphical represenation of the contour of a *Periode*, following Götzinger ([@sec:götzinger1827]) and Schmitthenner ([@sec:schmitthenner1824]), shown here in [@fig:diesterweg1838_169] [@diesterweg1830: 191], shown here in the version from the third edition [@diesterweg1838: 169]. Diesterweg proposes a consistent use of punctuation marks, with semicolons for sequences of *Beiordung* and colons for the main structural maximum. With this analysis, Diesterweg follows the approach from Schmitthenner and Götzinger that each *Periode* has a single maximum.

::: {.im #diesterweg1838_169}
The structure of the *Periode* [@diesterweg1830: 191; @diesterweg1838: 169], clearly inspired by Schmitthenner and Götzinger. The structure is actually closest to Götzinger as shown in [@fig:götzinger1827_263]. Each *Periode* has a single structural maximum, which is indicated by the colon between two slanted lines. The semicolons are always linking a *Beiordnung* and were originally accompanied by a horizontal line [@diesterweg1830: 191]. When the horizontal lines were removed in later editions [e.g. @diesterweg1838: 169 shown here], the same structure as found in Götzinger [-@gotzinger1827: 263] is obtained.
:::

In the 1830 edition Diesterweg also proposes a notation for subordinated clauses using a raised star (*) and coordinated clauses using a the typographic dagger (†). Deeper embedded clauses are marked by repeating these symbols [@diesterweg1830: 188-190]. These symbols are placed at the start of each clause, resulting in examples like [@next], shown in the original in [@fig:diesterweg1830_189], somewhat reminiscent of the use of letters by Herling, shown in [@herling1823_233].
...
::: {.im #diesterweg1830_189}
Inserted stars and typographic daggers to indicate the subordination structure of a large complex sentence from Diesterweg [-@diesterweg1830: 189]. Deeper embedding is marked by repeating the symbols of the level above. This approach of inserting symbols in the text is reminiscent of the original proposals by Herling as shown in [@fig:herling1832_232].
:::
...
Although Lehmann's book does not appear to have been reprinted after the first edition from 1833, it has influenced later more widely read works by Götzinger (see [@sec:götzinger1827]) and Bauer (see [@sec:bauer1850]), whose graphical displays will be reprinted up to 1935. Götzinger's acknowledgement indicates that Lehmann's approach might have had some real influence in didactic circles, although it has not endured to the present day:
...
# Visual syntax in textbooks {#sec:textbooks}
...
There is a curious graphic in the first edition of the *Deutsche Sprachlehre für Schulen* [@gotzinger1827: 263], reproduced here in [@fig:götzinger1827_263] from the second edition because of the higher quality of the scan [@gotzinger1830: 263]. The graphic indicates the *Hebung* 'raising' and *Senkung* 'lowering' of the various *Glieder* of a *Periode*. For example, the example sentence in [@next] illustrates the option *Viergliedrig*, in this case probably intended to show a case with three rising *Glieder* and a final falling one. This graphical representation is clearly adapted from Schmitthenner (see [@sec:schmitthenner1824]), who is cited by Götzinger.

::: ex
[*Glied* 1]{.grey} Wo göttliche Kraft und Empfindung die Gedanken belebt; \
[*Glied* 2]{.grey} wo Dank und Bitte auf den Flügeln des Wortes zum Himmel steigt; \
[*Glied* 3]{.grey} wo ein heiliger Ort den umherschweifenden Sinn feßelt und sammelt – \
[*Glied* 4]{.grey} da ist Religion. \
[@gotzinger1827: 264, citing Johann Friedrich Köppen *Über Offenbarung*]
:::

::: {.im #götzinger1827_263}
Götzinger's early attempt to list different kinds of sentence combinations inside a *Periode* [@gotzinger1827: 263]. The *Periode* consists of multiple *Glieder* that have a rising or falling part, as indicated by the lines. By the fact that all possible structures always have a single rising part and a single falling part, Götzinger implies that each *Periode* should always have a single central maximum.
:::
...
The fourth edition [@beilhack1838] is completely reworked. Besides citing Becker, in the preface Beilhack now also notes the influence from Götzinger ([@sec:götzinger1827]), Herling ([@sec:herling1823]), Lehmann ([@sec:lehmann1833]) and Horn ([@sec:horn1837]).
...
The *Deutsche Sprachschule* was published by Klinkhardt in Leipzig, and it appears that this involvement was more than simply printing and distributing the books. Around 1870 the founder Julius Klinkhardt (1810-1881) stepped down and the firm expanded unter the guidance of his sons Robert Julius (1841–1908) und Bruno (1843–1897). They might have seen an opportunity with this textbook to expand their reach. Many different versions of the *Deutsche Sprachschule* were produced, for different types of schools and for different regions, involving many different authors. The Austrian version (see below) was eventually published by Manz in Vienna, which actually by that time was a full subsidiary of Klinkhardt. The name *Deutsche Sprachschule in konzentrischen Kreisen* feels almost like a brand that was actively spread, instigated by the publisher. After 25 years the publisher even donated a substantial sum to an endowment with the goal to provide grants to teachers:

> Dem Sächsischen Pestalozzi-Verein hat die Firma Julius Klinkhardt in Leipzig aus Anlass des 25jährigen Bestehens der *Deutschen Sprachschule* in Gemeinschaft mit den Verfassern dieses Werkes, den Schuldirektoren Baron, Junghanns und Schindler in Dresden, 10 000 M in 3½ prozentigen Wertpapieren unter dem Namen *Kurstiftung des Verlegers und der Verfasser der Deutschen Sprachschule* übergeben. Aus den Zinsen sollen Kurbeihilfen an Lehrer gewährt werden.^[Cited from the *Schlesische Schulzeitung* of 27 Juli 1899, Volume 28, Issue 30, page 389, available online at <https://sbc.org.pl/Content/505352/PDF/iii54812-1899-30-0001.pdf>, accessed 4 September 2026.]
>
> ('To mark the 25th anniversary of the *Deutsche Sprachschule*, the firm of Julius Klinkhardt in Leipzig, jointly with the work's authors, School Directors Baron, Junghanns, and Schindler of Dresden, presented the Saxon Pestalozzi Association with 10,000 marks in 3½ percent securities under the name "Endowment Fund of the Publisher and Authors of the *Deutsche Sprachschule*." The interest generated is to be used to provide grants to teachers for health resort stays.')

In the most advanced 8th volume of the original *Deutsche Sprachschule* from 1875 a simplistic analysis of complex sentences with letters is introduced [cited here from the second edition, @baron1875: 2-36]. As many others around this time, capital letters indicate main clauses, while lowercase letter are used for subordinate clauses. Levels of subordination are indicated by superscript numbers. There is a possible influence from Josef Lehmann (see [@sec:lehmann1870]), who wrote his first book in Teplitz, which is close to Dresden. The most telling indication for an influence from Lehmann is the usage of the letter *v* to indicate *verkürzte* i.e. non-finite subordinate sentences.

In the discussion of the *Periode* a graphical representation is used similar to a proposal by Diesterweg (see [@sec:diesterweg1830]), though a similar image is also found in the work of Josef Lehmann. The example from Baron et al. [-@baron1875: 38] is shown in [@fig:baron1875_38] for the quotation from a prayer by Emanual Geibel in [@next].
...
There is also an Austrian version, prepared by M. Stein, Bernhard Weiner and Wenzel Wrany in 1880.^[I have not been able to find any biographical information about these people, except that Wrany was probably born in 1854. Not even the first name of Stein is documented anywhere.] The earliest Austrian version that I have been able to access is the three-volume B version *für Volksschulen* [@stein1880]. In the most advanced volume (for the *Oberstufe*) a simplified approach to the analysis of the *Periode* is included, as shown in [@fig:stein1880_67] for the example in [@next].^[This example does not appear to be a literary quotation. Interestingly, exactly the same example is found in the *Kurze deutsche Sprachlehre*, originally written in 1860 by the Baltic teacher Heinrich Westberg (1797-1871). A later edition of that book is available online at <https://www.digar.ee/arhiiv/en/books/56060>. Basic biographical data on Westberg is available at <https://bbld.de/GND1207706582>. Both links were accessed on 4 September 2026.] Only the overarching structure is marked, using a double pipe || to separate *Vordersatz* from *Nachsatz* and using large equal signs = for the separation of *Hauptgedanken*. These parts correspond to the slanted lines in the more advanced visual analysis in [@fig:baron1875_38]. Each part can in turn contain multiple clauses, but these are not further analysed in this version.

::: ex
Ein großer Theil unserer Fehler lässt sich verbessern und wieder gut machen, [=]{.grey} die meisten Arten des Verlustes, welche wir erleiden, lassen sich vergüten und sind eines Ersatzes fähig: [||]{.grey} aber unverbesserlich, schlechterdings unverbesserlich ist der Fehler, durch welchen wir unsere Zeit verschwenden, [=]{.grey} unersetzlich, ewig enersetzlich ist der Schade, welchen wir dadurch leiden.
:::

::: {.im #stein1880_67}
Simple separation of the *Periode* [@last] from Stein et al. [-@stein1880: 67]. The main parts are separated by || and = symbols. These parts represent the slated lines from [@fig:baron1875_38]. The detailed structure of the (multiple) subordinate clauses within each part is not further analysed.
:::

There is another version of the *Sprachschule* by Stein et al., which is probably the equivalent of the A version from Baron et al. I have been able to access the sixth edition from 1883, which consists of seven volumes. The third volume has an appendix with a more theoretical approach to the structure of sentences. At the end of this appendix there is a *Muster der Satz- und Wortanalyse* 'example of sentence and word analysis' [@stein1883_3: XXIV] for sentence [@next] as shown in [@fig:stein1883_xxiv]. Although the structure of the analysis, with the words of the sentence as a column to the left, is reminiscent of the tabular approach by Becker (cf. [@fig:becker1829_xvii]), this schema does not include any concrete dependency structure as used by Becker.

::: ex
Der kluge Hausvater gedenkt in glücklichen Zeiten der kommenden Tage der Entbehrung.
:::

::: {.im #stein1883_xxiv}
*Muster der Satz- und Wortanalyse* for the example in [@next] from the appendix in Stein et al. [@stein1883_3: XXIV]. The use of a tabular structure is reminiscent of Becker (cf. [@fig:becker1829_xvii]), but in this example there is no explicit indication of the dependency structure between the words.
:::

The seventh volume [@stein1883_7: 20-38] contains basically the same analysis of complex sentences and of the *Periode* as the original version from Baron et al. in [@fig:baron1875_38]. However, Stein at al. in [@fig:stein1883_38] use different letters depending on the syntactic function of the subordinate clauses, which they explain as shown below [@stein1883_7: 26, footnote]. This approach might have been inspired by the work of Josef Lehmann (see [@sec:lehmann1870]).

- s = Subjectsatz
- p = Prädicatsatz
- a = Attributivsatz
- o = Objectsatz
- uo = Umstandssatz des Ortes
- uz = Umstandssatz der Zeit
- uw = Umstandssatz der Weise
- ug = Umstandssatz des Grundes
- s^v^ = Verkürzter Subjectsatz

::: {.im #stein1883_38}
*Bezeichnung der Periode durch Formeln in Linien und Buchstaben* for example [@llast] from Stein et al. [-@stein1883_7: 38]. This image illustrates the structure of the same sentence as the image from Baron et al. in [@fig:baron1875_38]. Besides slightly different typesetting, the major difference is that Stein et al. here add different letters for different syntactic functions of subordinate clauses, namely *s*=subject complement clause, *a*=attributive (relative) clause and *o*=object complement clause.
:::

A few years later, in 1889/1890, the Austrian version is revised by Michael Binstorfer. In the third volume of the four-volume version the tabular analysis from [@fig:stein1883_xxiv] is repeated, but Binstorfer adds a separate *Satzanalyse* as shown in [@fig:stein1889_88]. The syntactical structure of the clause is illustrated with hierarchical brackets. Different from all other approaches to clausal syntax up to this point, this graphic represents a constituency analysis and not a dependency structure. The explanation to the right of the figure describes the dependency relations between the words. A similar graphical analysis is also given in the fourth volume [@stein1890: 92].

::: {.im #stein1889_88}
*Satzanalyse* for the example in [@last] from the revision of Stein et al. [-@stein1889: 88] by Binstorfer. He adds this hierachical analysis to the tabular analysis from the earlier version, shown in [@fig:stein1883_xxiv]. This appears to be first example of hierarchically organised brackets for the internal structure of a clause.
:::

In 1899 Binstorfer prepares yet another version of this text book, now as a single volume *für österrichische Bürgerschulen* [@stein1899]. The tabular analysis with hierarchical brackets returns [@stein1899: 37], but a completely new section with *Satzbilder* for complex sentences is introduced [@stein1899: 57-62], clearly inspired by the work of Trunk (see [@sec:trunk1895]). The abbreviations are similar to the abbreviations from the 1883 version (as listed above), and it is very probable that Trunk adapted his abbreviations on the basis of the *Deutsche Sprachschule*. However, in the 1899 version, Binstorfer simply takes over the conventions of Trunk [@stein1899: 57 footnote]. The use of the line diagrams is explained in detail in the section on Trunk's work, but basically, the left-to-right ordering reflects that actual order of the sentence, while the top-down ordering reflects that depth of embedding.

::: ex
[e]{.grey} Wie weit die Kräfte, [b]{.grey} die dir Gott gab, [e]{.grey} sich erstrecken, [A]{.grey} das kannst du nur, [uw]{.grey} indem du sie gebrachst, [A]{.grey} entdecken. [@stein1899: 58, citing a poem from Friedrich Rückert]
:::

::: {.im #stein1899_58}
*Satzbild* for the sentence in [@last] from Stein et al. [@stein1899: 58] in the revision of Binstorf. This visual approach is clearly adapted from Trunk, cf. [@fig:trunk1895_314]. Also the meaning of the letters is identical to Trunk, e.g. e=*Ergänzungssatz* (complement clause), b=*Beifügesatz* (relative clause), uw=*Umstandssatz der Art und Weise* (adverbial clause).
:::
...
As a summary of his criticism Raumer presents various renditions of *Periodenbilder* for the same complex sentence, repeated here in [@next]. Two different proposals by Kern are illustrated, alongside displays in the style of Nägelsbach (cf. [@sec:nägelsbach1846]) and Götzinger (cf. [@sec:götzinger1827]). I have not been able to find the source of proposal number (3) in [@fig:raumer1902_63]. There is no citation in the article itself, and none of the proposals currently discussed in this book look like this *Periodenbild*.
...
# *Periodenbilder* for literary analysis {#sec:literary}
...
# Constituency in Germany {#sec:germanconstituency}
...
Word "Topologie" used by Bech, chapter called "Zur topologie der verbalfelder" [@bech1955: 60]
