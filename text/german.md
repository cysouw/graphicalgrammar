...
The idea that every sentence should contain some kind of copula is less widespread. At the start of the 19th century the verb is sometimes still considered to be an amalgamation of a copula and a predicate. Linguistically this approach not make much sense and is mostly ignored. However, much later Wilhelm Wundt still deemed it necessary to argue agains the "old grammarians" insisting on a univeral copula [@wundt1900b: 222-224].

## The concept of *nackte Sätze* {#sec:nackt}

In German grammars of the late 18th and early 19th century there is a widespread conceptual distinction between a bare and an extended sentence. A bare sentence is mostly defined as a sentence with only a subject and a predicate, but without any attributive or adverbial modifiers; a minimal sentence of sorts. The examples given always have intransitive verbs and it remains unclear whether transitive sentences also could be "bare". An extended sentence, in contrast, contains additional modifiers, though subordinate clauses are mostly relegated to yet further categories of sentence structure (cf. the *Periode* in [@sec:period]). This distinction between bare and extended is mostly referred to using the German words *nackt* 'naked' vs. *ausgebildet* 'developed'.^[This distinction might have been inspired by the latinistic tradition distinguishing between *syntaxis regularis* and *syntaxis ornata*.] However, there is some interesting variations and discussion throughout the 19th century about exactly which word should be used.
...
## The *Periode* and its *Periodenbild* {#sec:period}
