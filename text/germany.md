...
Graphical analysis of the sentence in [@last] from Zitzlsperger [-@zitzlsperger1871: 135]. The notional details very similar to those of Bauer (see [@sec:bauer1850]). The underlining is new, and the meaning of the superscripts is different from Bauer.
:::
